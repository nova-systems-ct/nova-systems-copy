...
// each defined their own local `GOLD = "#D4A030"`) is exactly what this file replaces.
//
// Migration note: existing public pages still use the older black (#0a0a0a) + #D4A030 gold
// scheme. This file is the target for an ongoing migration, not a claim that every page has been
// converted yet — see docs/implementation-status.md for what's been moved over so far.
